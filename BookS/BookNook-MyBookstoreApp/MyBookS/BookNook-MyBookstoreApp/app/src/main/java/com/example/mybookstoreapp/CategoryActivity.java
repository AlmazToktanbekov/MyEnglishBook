...
public class CategoryActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Firebase", "Initialized Firebase successfully");
...
//        });
        ...
        public void toBookDisplay(View v) {
            ...
            Log.d("CategoryActivity", "Values passed: " + values[0] + ", " + values[1] + ", " + values[2]);
    ...
    public void BookNovelView(View v){
        ...
        switch (v.getId()) {
            case (R.id.English):
                ...
                ((ToggleButton)findViewById(R.id.Arabic)).setChecked(false);BookNovel.setFocusable(true);
